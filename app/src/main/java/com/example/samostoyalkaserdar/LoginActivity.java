...
public class LoginActivity extends AppCompatActivity { private EditText log_emaill, log_passs;
    ...
    protected void onCreate(Bundle savedInstanceState) { super.onCreate(savedInstanceState); setContentView(R.layout.activity_login);
        ...
        log_emaill=findViewById(R.id.log_email); log_passs=findViewById(R.id.log_pwd); log_btnn=findViewById(R.id.btn_login); firebaseAuth=FirebaseAuth.getInstance();

        log_btnn.setOnClickListener(new View.OnClickListener() { @Override
        public void onClick(View view) {
            String e=log_emaill.getText().toString().trim(); String p=log_passs.getText().toString().trim(); firebaseAuth.signInWithEmailAndPassword(e,
